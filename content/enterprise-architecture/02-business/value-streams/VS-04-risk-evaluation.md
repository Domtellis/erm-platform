...
| Key activities | 1) Evaluate residual vs appetite;<br>2) Rank and cluster (themes/systemic/concentration);<br>3) **AI-Assisted Concentration Detection** (Pattern-based systemic risk clustering);<br>4) Identify single points of failure and critical service exposures;<br>5) Select response approach per risk;<br>6) Build prioritised treatment backlog;<br>7) Allocate owners and funding;<br>8) Set review cadence by volatility;<br>9) Publish portfolio decisions and actions. |
