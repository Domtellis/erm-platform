...
journey_id: journey-control-owner-assurance
persona_id: per-004
...
## Goals
- Execute and evidence controls with provenance; minimise audit fire drills.
- Manage exceptions/issues; validate closure independently.
- Feed control health back into risk posture and monitoring.

## Steps (end-to-end)
| # | Value stream | What the user is trying to do | Emotions | Pain points | Success criteria |
|---|-------------|--------------------------------|----------|-------------|------------------|
| 1 | VS-05 | Align control design to treatments/obligations; define evidence/test approach | Structured | Incomplete evidence standards | Evidence requirements standardised |
...
- One-click audit pack generation (VS-06/VS-08).
- Issue closure requires independent verification (VS-06).

## Success criteria (measurable)
- Evidence automation rate >= 70% (maturing to 90%).
- Repeat audit findings <= 5% per year.
- Issue remediation cycle time improves by severity band.
