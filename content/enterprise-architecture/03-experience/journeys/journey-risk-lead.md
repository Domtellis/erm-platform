...
journey_id: journey-risk-lead
persona_id: per-002
primary_value_streams: [VS-00, VS-03, VS-04, VS-08]
secondary_value_streams: [VS-01, VS-02, VS-05, VS-06, VS-07, VS-09]
last_updated: 2026-02-03
---

# Journey Map — Enterprise Risk Lead / CRO Function

## Goals
- Operate a consistent ERM system with standards, QA, and effective challenge.
- Ensure evidence-based assessments and defensible prioritisation.
- Reduce rework and keep the portfolio current.
...
| 8 | VS-08 | Produce decision-ready reporting with certification gates | Accountable | Conflicting figures | Certification passes first time |

## Moments that matter
- Evidence-first assessment submission (VS-03).
- Portfolio “why now” ranking explanations (VS-04).
- One-click audit-ready decision pack generation (VS-08).

## Success criteria (measurable)
- Rework after challenge <= 15%.
- >= 95% material assessments meet evidence minimums.
- “Surprise events” count falls quarter-on-quarter.
