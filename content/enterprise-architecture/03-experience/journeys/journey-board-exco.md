...
## Goals
- Approve appetite and guardrails; enforce consistent escalations.
- Maintain a clear view of top risks, concentrations, and material changes.
- Make timely, defensible decisions with traceability.
...
## Key artefacts and evidence
- Appetite statement, criteria model version, escalation matrix (VS-00).
- Top risk portfolio and decision ledger entries (VS-04, VS-08).
- Breach log and mitigation verification evidence (VS-07).

## Success criteria (measurable)
- >= 95% packs signed off on time.
- >= 98% decisions have complete traceability (risk → evidence → actions).
- Decision latency decreases quarter-on-quarter.
