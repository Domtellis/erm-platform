...
const reportBreach = (token) => {
    return new Promise((resolve) => {
        const payload = JSON.stringify({
            site_id: 'SITE-BETA-02',
            metric_name: 'pressure',
            observed_value: 500,
            severity: 'medium', // Explicitly MEDIUM
            description: 'Test Medium Breach',
            category: 'safety',
            bu_id: 'BU-WEST-01'
        });
...
const createAndApprove = (token, breachId) => {
    ...
    const payload = JSON.stringify({
        ...
        rationale: 'Risk Lead Mitigation for Medium',
