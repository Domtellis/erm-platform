...
export class DecisioningController {
    ...
    async approve(@Param('id') id: string, @Body() dto: ApproveDecisionDto, @Request() req) {
        return this.decisioningService.approveDecision(id, dto, req.user, req.headers.authorization);
    }
