...
export class ReportingService {
    ...
    async getRiskTrends(days: number = 30) {
        ...
        const trendMap = new Map<string, { date: string; critical: number; high: number; medium: number; low: number }>();
